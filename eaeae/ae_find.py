...
keys[0][0]= {(88, 20), (18, 73), (21, 84)}
keys[1][1]= {(121,17),(13,91),(120,70)}
keys[2][2]= {(39,43),(106,17),(109,15)}
keys[3][3]= {(84,75),(72,12),(98,105)}
keys[4][4]= {(116,57),(45,73),(93,112)}
keys[5][5]= {(36,61),(42,50),(49,11)}
keys[6][6]= {(1,52),(107,27),(19,27)}
keys[7][7]= {(29,38),(55,58),(43,11)}
...
s = to_char(decode("lhhsmhjimukujqftmmjfipgoislplgiq"))
print(s)
